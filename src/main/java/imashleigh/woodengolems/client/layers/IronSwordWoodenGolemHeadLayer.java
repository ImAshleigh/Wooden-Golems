...
@OnlyIn(Dist.CLIENT)
public class IronSwordWoodenGolemHeadLayer extends LayerRenderer<IronSwordWoodenGolem, IronSwordWoodenGolemModel> {
   public IronSwordWoodenGolemHeadLayer(IEntityRenderer<IronSwordWoodenGolem, IronSwordWoodenGolemModel> p_i50922_1_) {
      super(p_i50922_1_);
   }

   public void render(IronSwordWoodenGolem entityIn, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) 
   {
