...
@OnlyIn(Dist.CLIENT)
public class DiamondSwordWoodenGolemHeadLayer extends LayerRenderer<DiamondSwordWoodenGolem, DiamondSwordWoodenGolemModel> {
   public DiamondSwordWoodenGolemHeadLayer(IEntityRenderer<DiamondSwordWoodenGolem, DiamondSwordWoodenGolemModel> p_i50922_1_) {
      super(p_i50922_1_);
   }

   public void render(DiamondSwordWoodenGolem entityIn, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) 
   {
