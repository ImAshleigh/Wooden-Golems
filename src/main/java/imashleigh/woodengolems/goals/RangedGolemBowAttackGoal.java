...
public class RangedGolemBowAttackGoal<T extends CustomGolem & IRangedAttackMob> extends Goal {
	   ...
	   public RangedGolemBowAttackGoal(T mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn) {
	      this.entity = mob;
